...
class Electricite extends StatefulWidget {
  final String userID;
  const Electricite({super.key, required this.userID});

  @override
  State<Electricite> createState() => _ElectriciteState();
}

class _ElectriciteState extends State<Electricite> {
  final ListServiceController serviceController = ListServiceController();

  // دالة لجلب الخدمات من API
  Future<List<dynamic>> fetchServices() async {
    return await serviceController.ListService('v2'); // الفاميلي سيرفيس v2
  }
